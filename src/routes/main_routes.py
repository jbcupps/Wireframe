...
EXPLORERS = {
    ...
    "klein": {
        ...
        "time": "8 min",
        "look_for": "Rotate until the neck comes into view, then trace the bright path around its surface.",
        "control_hint": "Use wireframe to see how the surface is sampled, then return to the shaded view.",
        "next_slug": "curves",
    },
    "crosscap": {
    ...
    "projective": {
        ...
        "level": "Build intuition",
        "time": "8 min",
        "look_for": "Find two regions that look far apart in the drawing, then imagine identifying opposite points.",
        "control_hint": "Rotate before changing the twist; the projection is the first idea to inspect.",
        "next_slug": "klein",
    },
    "curves": {
        "title": "Closed Curves",
        ...
        "accent": "#22c55e",
        "level": "Connect the ideas",
        "time": "6 min",
        "look_for": "Compare the paths: which loops can be continuously reshaped into one another?",
        "control_hint": "Pause the motion to compare the paths one at a time.",
        "next_slug": "crosscap",
    },
    "immersion": {
        "title": "4D Immersions",
        ...
        "accent": "#38bdf8",
        "level": "See a projection",
        "time": "6 min",
        "look_for": "Watch a vertex appear to move through the frame. The motion is a projection, not a new dimension on the screen.",
        "control_hint": "Move the twist control in small steps to isolate the hidden-axis rotation.",
        "next_slug": "projective",
    },
}
...
def forces_evolution():
    """Guided forces-and-evolution visualization route."""
...
def topology_explorer(slug):
    ...
    if explorer is None:
        abort(404)
    next_slug = explorer["next_slug"]
    return render_template(
        'topology_explorer.html',
        slug=slug,
        explorer=explorer,
        next_explorer=EXPLORERS[next_slug],
        next_slug=next_slug,
    )
